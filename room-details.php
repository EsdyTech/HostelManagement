		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row" id="print">
					...
					<div class="col-md-12">
						<h2 class="page-title" style="margin-top:3%">Hostel Registration Details</h2>
...
<td><?php if($row->roomAllotedId == 0){ echo "No Room Alloted Yet!";} else{
...
$restt="select * from userregistration where regno=?";
$st= $mysqli->prepare($restt) ;
$st->bind_param('s',$regNo);
$st->execute() ;
$re=$st->get_result();
$rws=$re->fetch_object();
?>
<tr>
<td><b>Reg No. :</b></td>
<td><?php echo $rws->regNo;?></td>
<td><b>Full Name :</b></td>
<td><?php echo $rws->firstName;?>  <?php echo $rws->middleName;?>  <?php echo $rws->lastName;?></td>
<td><b>Email :</b></td>
