...
$query="update hostels set hostelName=?,noOfRooms=?,noOfAvailableRooms=?,fees=?,location=? where id=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sssssi',$hostelName,$noOfRooms,$noOfAvailableRooms,$fees,$location,$id);
$stmt->execute();
...
<div class="col-sm-8">
<input type="text" class="form-control" name="hostelName" id="hostelName"value="<?php echo $row->hostelName;?>" required="required">
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Number of Rooms</label>
<div class="col-sm-8">
<input type="text" class="form-control" name="noOfRooms" value="<?php echo $row->noOfRooms;?>" id="noOfRooms" required="required">
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Number of Available Rooms</label>
<div class="col-sm-8">
<input type="text" class="form-control" name="noOfAvailableRooms" value="<?php echo $row->noOfAvailableRooms;?>" id="noOfAvailableRooms" required="required">
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label">Fees Per Room</label>
<div class="col-sm-8">
<input type="text" class="form-control" name="fees" id="fees" value="<?php echo $row->fees;?>" required="required">
</div>
</div>
<div class="form-group">
