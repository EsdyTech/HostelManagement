...
$id=$_GET['id'];
$query="update hostels set hostelName=?,location=? where hostelId=?";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('ssi',$hostelName,$location,$id);
$stmt->execute();
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal">
												<?php	
												$id=$_GET['id'];
	$ret="select * from hostels where hostelId=?";
	 ...
	 //$cnt=1;
	   while($row=$res->fetch_object())
	  {
	  	?>
					...
					<div class="col-sm-8">
					<input type="text"  name="hostelName" value="<?php echo $row->hostelName;?>"  class="form-control"> </div>
					</div>
				 <div class="form-group">
...
<?php } ?>
												<div class="col-sm-8 col-sm-offset-2">
													...
													<input class="btn btn-primary" type="submit" name="submit" value="Update Hostel Details ">
												</div>
											</div>
