...
{
	$id=intval($_GET['del']);
	$adn="delete from hostels where id=?";
...
<td><?php echo $row->noOfAvailableRooms;?></td>
<td><?php echo $row->fees;?></td>
<td><?php echo $row->location;?></td>
<td><?php echo $row->posting_date;?></td>
<td><a href="edit-room.php?id=<?php echo $row->id;?>"><i class="fa fa-edit"></i></a></td>
