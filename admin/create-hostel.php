...
if($row_cnt>0)
{
echo"<script>alert('Hostel with this name ".$hostelName." alreadt exist');</script>";
}
else
{
$query="insert into  hostels (hostelName,location,dateCreated) values(?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('sss',$hostelName,$location,$dateCreated);
$stmt->execute();
