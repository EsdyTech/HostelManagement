...
$query="insert into  userRegistration(regNo,class,firstName,middleName,lastName,gender,contactNo,email,password) values(?,?,?,?,?,?,?,?,?)";
$stmt = $mysqli->prepare($query);
$rc=$stmt->bind_param('ssssssiss',$regno,$class,$fname,$mname,$lname,$gender,$contactno,$emailid,$password);
$stmt->execute();
